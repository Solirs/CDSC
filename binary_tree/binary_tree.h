...
int cdsc_btree_prune_node(struct cdsc_btree_node* node);
...
int cdsc_btree_foreach_pre_order(struct cdsc_btree_node* nod, void(*action)(), void* param);
int cdsc_btree_foreach_post_order(struct cdsc_btree_node* nod, void (*action)(), void* param);
...
int cdsc_btree_foreach_pre_order_recursive(struct cdsc_btree_node* nod, void(*action)(), void* param);
int cdsc_btree_foreach_post_order_recursive(struct cdsc_btree_node* nod, void (*action)(), void* param);

int cdsc_btree_graft_rchild(struct cdsc_btree_node* nod, struct cdsc_btree_node* parent);
int cdsc_btree_graft_lchild(struct cdsc_btree_node* nod, struct cdsc_btree_node* parent);
