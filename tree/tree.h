...
int cdsc_tree_prune_node(struct cdsc_tree_node* node);
void cdsc_tree_purge_node(struct cdsc_tree_node* node);
int cdsc_tree_graft(struct cdsc_tree_node* nod, struct cdsc_tree_node* parent);
...
int cdsc_tree_foreach_pre_order(struct cdsc_tree_node* nod, void(*action)(), void* param);
int cdsc_tree_foreach_post_order(struct cdsc_tree_node* nod, void (*action)(), void* param);
