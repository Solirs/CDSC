...
int main(){
    ...
    struct cdsc_tree_node* child3 = cdsc_tree_add_child(tree->root, "Hello3");
    struct cdsc_tree_node* child4 = cdsc_tree_add_child(tree->root, "Hello4");
    ...
    //prune_node(child);
    //graft(child, child2);
    struct cdsc_tree_node* tn = ((struct cdsc_tree_node*)cdsc_linkedlist_getindexfromhead(rootnode->children, 0));
    printf("%s\n", (((struct cdsc_tree_node*)cdsc_linkedlist_getindexfromhead(tn->children, 1))->data));
    ///printf("%d\n", get_depth(child));
