...
int main(){
    ...
    struct tree_node* child = cdsc_tree_add_child(tree->root, "Hello1");
    struct tree_node* child2 = cdsc_tree_add_child(tree->root, "Hello2");
    struct tree_node* child3 = cdsc_tree_add_child(tree->root, "Hello3");
    struct tree_node* child4 = cdsc_tree_add_child(tree->root, "Hello4");

	struct tree_node* ch4 = cdsc_tree_add_child(child, "Hello11");
	struct tree_node* ch5 = cdsc_tree_add_child(child, "Hello12");
	struct tree_node* ch6 = cdsc_tree_add_child(child3, "Hello31");
    ...
    //struct tree_node *child3 = cdsc_tree_add_child(child, "bye");
    //remove_node(child);
    //prune_node(child);
    //graft(child, child2);
